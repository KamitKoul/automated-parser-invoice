...
export default function Documents() {
  ...
  // Run once on mount: load vendor list and initial docs.
  // `loadDocs` is intentionally omitted from the dependency array to avoid
  // re-running the effect on state updates (we call `loadDocs` manually via Apply).
